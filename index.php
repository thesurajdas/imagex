    ...
    <body>
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img draggable="false" src="upload\images\d50c792a35.jpg" class="d-block cimg" alt="...">
                  ...
                  <div class="carousel-item">
                    <img draggable="false" src="upload\images\75c37a2060.jpg" class="d-block cimg" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="carousel-item">
                    <img draggable="false" src="upload\images\96fbc5671e.jpg" class="d-block cimg" alt="...">
                    <div class="carousel-caption d-none d-md-block">
        ...
        <div class="container shadow-lg p-3 mt-4 mb-5 my-3" style="border-radius: 1.25rem;">
            <div class="container shadow-lg p-3 mb-5 bg-white my-3 glry" style="border-radius: 1.25rem">
                ...
                ?>
                    <a href="<?php echo "pages/image.php?id=".$row_fi['image_id']; ?>"><div class="item"><img draggable="false" class="fci im" src="<?php echo $site_url,$row_fi['image_location']; ?>" alt=""></div></a>
                <?php endwhile; ?>
                </div>                  
            </div>
            <div class="container shadow-lg p-3 mb-5 bg-white my-3 glry" style="border-radius: 1.25rem">
