                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-2 text-center pr-0 chbtn">
                                                            <button type="button" class="btn  pr-0"  data-toggle="modal" data-target="#shareimg" onclick="shareimgpop(<?php echo $row['id'];?>);" style="color:white"><i class="fad fa-share-square"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
