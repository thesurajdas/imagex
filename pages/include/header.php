...
<<<<<<< HEAD
                            <input type="search" autocomplete="off" name="q" id="query" class="form-control sbdr rounded-pill pr-5" placeholder="Search" <?php if(isset($_GET['q'])){echo "value='".$_GET['q']."' ";} ?> required>
=======
...
>>>>>>> 67957f369b769e678afc37438f9366aa8523afca
                            <div class="col-auto">
