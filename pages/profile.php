...
<html lang="en">
    ...
    <body>
        ...
        <!-----------------------------------------Profile section------------------------------------------------------>
        <img draggable="false" src="../upload/images/91129aa8a8.jpg" class="bacwall" alt="">
                ...
                <div class="row prow" style=" margin-top: 100px">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img draggable="false" class="rounded-circle pix" src="<?php echo $site_url."/".$user_avatar; ?>" alt=""/>
                        </div>
                    </div>
                    <div class="col-md-6">
      ...
      $.ajax({
        ...
        success: function(data){
          if(data){
            ...
            //no result
            $("#searching").html("<img style='height: 150px; width: 150px; object-fit: contain;' src='../img/notfound.svg' alt=''><h2 style='padding-top: 20px; padding-bottom: 25px; color: #6c757dd4;'>You Haven't Uploaded Any Images Yet. <a href='../pages/upload.php' class='btn btn-success rounded-pill shadow-sm'><i class='fas fa-cloud-upload'></i> Upload Now</a>");
        ...
        success: function(data){
          if(data){
            ...
            $("#loadLiked").append(data);
              ...
              //noresult
            $("#searchingl").html("<img style='height: 150px; width: 150px; object-fit: contain;' src='../img/heart.svg' alt=''><div class='container'><h2  style='padding-top: 20px; padding-bottom: 25px; color: #6c757dd4;'>You Haven't Saved Any Images Yet. <a href='../pages/trending.php' class='btn btn-danger rounded-pill shadow-sm'><i class='fad fa-lightbulb-on' style='color:#f8f9fa'></i> Browse</a></h2></div>");
