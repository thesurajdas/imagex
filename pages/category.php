        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                if(data){
                    ...
                    $("#searching").html("<div class='container text-center'><img style='height: 150px; width: 150px; object-fit: contain;' src='../img/notfound.svg' alt=''><h2 style='padding-top: 20px; padding-bottom: 25px; color: #6c757dd4;'>Sorry! We Don't Have Any Images On This '<?php echo $row_cat_name['category']; ?>' Category Yet. <i class='fad fa-heart-broken' style='color: red;'></i></div>");
