                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12 sglry">
                                        <div class="card cds">
                                            ...
                                            <div class="card-text cds-txt">
                                                ...
                                                echo $site_url.'/pages/profile.php?u='.$username; ?>" class=" text-decoration-none text-white"><img draggable="false" class="upimg" src="<?php echo $site_url."/".$user_avatar; ?>" alt="" onContextMenu="return false;"> <?php echo $fullname; ?></a>
                                                <div class="container">
                                                    <div class="row">
