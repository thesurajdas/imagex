...
$count=0;
	                            ...
	                            $sql="SELECT * FROM images WHERE visibility=0 ORDER BY time DESC LIMIT {$page},$limit";
                                ...
                                while($row=$result_img->fetch_assoc()):
                                    ...
                                    <div id="<?php $row['id'];?>" class="col-lg-4 col-md-6 col-sm-12 sglry">
                                        ...
                                        <?php $img_url=$site_url.$row['image_location']; ?>
                                            <img draggable="false" class="im" draggable="false" src="<?php echo $site_url; ?>/pages/api.php?image=<?php echo $img_url; ?>" loading="lazy" onContextMenu="return false;" alt="Card image cap" onContextMenu="return false;">
                                            <div class="card-text cds-txt">
                                                ...
                                                echo $site_url.'/pages/profile.php?u='.$username; ?>" class=" text-decoration-none text-white"><img draggable="false" class="upimg" src="<?php echo $site_url."/".$user_avatar; ?>" onContextMenu="return false;" alt="" style="object-fit: cover;"> <?php echo $username; ?></a>
                                                <div class="container">
                                                    <div class="row">
