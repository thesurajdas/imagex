                                ...
                                while($row=$result_img->fetch_assoc()):
                                    ...
                                    <div id="<?php $row['id'];?>" class="col-lg-4 col-md-6 col-sm-12 sglry">
                                        ...
                                        <?php $img_url=$site_url.$row['image_location']; ?>
                                            <img draggable="false" class="im" draggable="false" src="<?php echo $site_url; ?>/pages/api.php?image=<?php echo $img_url; ?>" onContextMenu="return false;" alt="Card image cap" onContextMenu="return false; ">
