                                                    ...
                                                    ?>           
                                                        <div class="col-lg-4 col-md-6 col-sm-12 sglry">
                                                                ...
                                                                <?php $img_url=$site_url.$row['image_location']; ?>
                                                                    <img class="im" draggable="false" src="http://localhost/imagez/pages/api.php?image=<?php echo $img_url; ?>" onContextMenu="return false;" alt="Card image cap">
                                                                    <div class="card-text cds-txt">
                                                                        ...
                                                                        echo $site_url.'/pages/profile.php?u='.$username; ?>" class=" text-decoration-none text-white"><img draggable="false" class="upimg" src="<?php echo $site_url."/".$row_img_user['avatar']; ?>" onContextMenu="return false;" alt="" style="object-fit: cover;"> <?php echo $username; ?></a>
                                                                        <div class="container">
                                                                            <div class="row">
                                                                                <div class="row col-10 chbtn">
                                                                                    ...
                                                                                    ?>
                                                                                    <a class="btn btn-outline-danger cbtn" style="margin-right: 5px; color: #fff;" id="<?php echo $image_id; ?>" onclick="mylike(<?php echo $image_id; ?>)" title="Like This Image"><span style="<?php echo $like_color;?>"><i class="<?php echo $icon; ?> fa-heart"></i></span> <span><?php echo $row['likes']; ?></span></a>
