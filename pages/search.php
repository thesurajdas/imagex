    ...
    <body>
        ...
        <div class="container shadow-lg p-3 mb-5 bg-white glry" style="border-radius: 1.25rem;">
            ...
            <div class="container shadow-lg pl-3 pr-3 pt-1 mt-4" style="border-radius: 1.25rem;">
                    ...
                    <div id="searching" class='container text-center'><img style='height: 150px; width: 150px; object-fit: contain;' src='../img/nodata.svg' alt=''><h2 style='padding-top: 20px; padding-bottom: 25px; color: #6c757dd4;'>Sorry! No Result Found. <i class='fad fa-heart-broken' style='color: red;'></i></div>     
            </div>
